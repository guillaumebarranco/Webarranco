...
<style>
	...
	<div class="slides">
		...
		<section class="mer">
			<img src="img/build/windwaker.jpg" width="800" height="400"/>
			<h1>Webarranco</h1><br />
		...
		<section id="mine">
			...
			<img src="img/build/html5sword.png" width="200" class="sword fragment" style="background: none; border: none; box-shadow: none;"/>
			<img src="img/build/css3shield.png" width="200" class="sword fragment" style="background: none; border: none; box-shadow: none;"/>
			<div class="fragment">
		...
		<section>
			...
			<img src="img/build/jsarrow.png" width="100" class="sword fragment" style="background: none; border: none; box-shadow: none;"/>
		...
		<section>
			<h2>L'arc: JQuery</h2>
			<img src="img/build/jquerybow.png" width="350" class="sword fragment" style="background: none; border: none; box-shadow: none;"/>
		...
		<section>
			...
			<img src="img/build/phpboomerang.png" width="300" class="sword fragment" style="background: none; border: none; box-shadow: none;"/>
		...
		<section>
			...
			<img src="img/build/sqlgrappin.png" width="200" class="sword fragment" style="background: none; border: none; box-shadow: none;"/>
		...
		<section>
			...
			<img src="img/build/flaconzf2.png" width="100" class="sword fragment" style="background: none; border: none; box-shadow: none;"/>
			<img src="img/build/flaconcake.png" width="100" class="sword fragment" style="background: none; border: none; box-shadow: none;"/>
			<img src="img/build/flacondoctrine.png" width="100" class="sword fragment" style="background: none; border: none; box-shadow: none;"/>
			<img src="img/build/flaconsass.png" width="100" class="sword fragment" style="background: none; border: none; box-shadow: none;"/>
			<img src="img/build/flaconcompass.png" width="100" class="sword fragment" style="background: none; border: none; box-shadow: none;"/>
